  ...
  return <main className="dashboard-page">
    <aside className="dashboard-sidebar">
      ...
      <nav className="dashboard-nav" aria-label="منوی اصلی">
        <a className="active" href="#overview">نمای کلی</a><a href="#projects">{isCustomer ? "درخواست‌های من" : "فرصت‌های خیاطی"}</a><Link href="/orders">سفارش‌ها و نظرها</Link>{!isCustomer && <Link href="/portfolio">نمونه‌کارها</Link>}<a href="#notifications">اعلان‌ها {unread > 0 && <b>{unread.toLocaleString("fa-IR")}</b>}</a>
      </nav>
